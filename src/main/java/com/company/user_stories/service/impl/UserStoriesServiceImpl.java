...
import com.company.user_stories.error.*;
...
public class UserStoriesServiceImpl implements UserStoriesService {
    ...
    public OperationResponse registerOrganization(RegisterRequest request) {
        Organization organization = organizationRepository.findByUserName(request.getUserName());
        ...
        throw new AlreadyRegisteredUsernameException("This user with name : " + request.getUserName() + " have already registered");
    }
